...
void test_is_greater_or_equal(s21_decimal number1, s21_decimal number2, int expected) {
    int result = s21_is_greater_or_equal(number1, number2);
...
START_TEST(test_is_greater_or_equal1) {
        ...
        test_is_greater_or_equal(number1, number2, check);
}
END_TEST
